...
えび(中)  えび(大)  いか  ちくわ  かぼちゃ  なす  さつま芋  ししとう  しいたけ  いんげん  青じそ  かき揚げ  天かす    
...
お好み焼  広島風お好み焼 焼きそば  焼きうどん  たこ焼き  もんじゃ  
インド インドカレー  キーマカレー  サモサ  タンドリーチキン  
アジア トムヤンクン  タイカレー  焼きビーフン  生春巻  
タコス  
コーヒー  紅茶  ココア  シェイク  ジュース
]

none_dishes = %w[
  手軽な朝メシ
  手軽な洋風朝メシ  
  手軽な材料で、チョコムースでおやつタイム
  手軽なパンで美味しいおやつ
  サラダカルパッチョと手軽な副菜で
  茹で鶏で手軽なフォーと生春巻きのランチ
  朝食に♡手軽なおかずと昨日の煮物アレンジ
  オッサンのブランチ
]
...
none_dishes.each do |recipe_title|
  all_ingredients = [group_1.sample, group_2.sample, group_3.sample, group_4.sample, group_5.sample, group_6.sample]
  recipes << Recipe.create!(
    title: recipe_title,
    kind: 3, # 温め器具を使わない
